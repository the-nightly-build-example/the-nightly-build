# Editor review-brief 01 — the-evidence/gpt-4-technical-report
...
- The exact writer brief (for prompt-leakage detection):
  `.nb-work/the-evidence/gpt-4-technical-report/agent-artifacts/the-evidence/gpt-4-technical-report/writer/01/brief.md`.
...
- Evidence record: `.nb-work/the-evidence/gpt-4-technical-report/agent-artifacts/the-evidence/gpt-4-technical-report/researcher/01/evidence.md` (open as a map in the
...
- Draft handoff (open the original-work sentence only in the third read):
  `.nb-work/the-evidence/gpt-4-technical-report/agent-artifacts/the-evidence/gpt-4-technical-report/writer/01/draft-handoff.md`.
- The article to review and edit in place: `.nb-work/the-evidence/gpt-4-technical-report/library/the-evidence/gpt-4-technical-report.html`.
- Template context: `.nb-work/the-evidence/gpt-4-technical-report/.nb-context/`.
...
habits. Read it in `.nb-work/the-evidence/gpt-4-technical-report/agent-artifacts/the-evidence/gpt-4-technical-report/commission.md` and flag any that recur.

## Permitted edits (surgical, never a rewrite)
- Make cuts and small prose fixes (up to a word or clause) directly in `.nb-work/the-evidence/gpt-4-technical-report/library/the-evidence/gpt-4-technical-report.html`.
...
- `.nb-work/the-evidence/gpt-4-technical-report/agent-artifacts/the-evidence/gpt-4-technical-report/editor/01/editorial-review.md` with the three required lines
...
Return exactly one line: `DONE editor .nb-work/the-evidence/gpt-4-technical-report/agent-artifacts/the-evidence/gpt-4-technical-report/editor/01/editorial-review.md` only
