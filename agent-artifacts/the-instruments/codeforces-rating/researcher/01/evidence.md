# Evidence: the-instruments/codeforces-rating (01)
...
- The o3 figure is quoted two ways. OpenAI's paper reports 2724 (99.8th
  percentile) from simulated contests (arxiv 2502.06807). The December 2024 o3
  announcement was widely reported as 2727, "on par with the 175th best
  competitive programmer," a framing that drops the estimated/simulated
  qualifier. The 2727 figure and the "175th" gloss trace to the livestream and
  secondary coverage, not to a primary OpenAI document I could open; treat 2724
  as the verified number and 2727/"175th" as the circulated claim.
...
```text
Figure: o3 = 2727, "175th best competitive programmer"
Owner:  OpenAI December 2024 o3 announcement (livestream), via secondary coverage
Scope:  Announced figure; not verified against a primary OpenAI document here.
        Differs from the paper's 2724. The "175th" gloss omits the
        estimated/simulated condition.
```
...
VentureBeat, Medium, and X posts on o3's 2727/"175th": secondary retellings of
  the OpenAI livestream. Used only to note the circulated framing under
  Contradictions; none owns the figure.
