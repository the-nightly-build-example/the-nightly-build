# Researcher brief 01 — when-ai-breaks/google-flu-trends

Load the `researcher` skill and follow it. This is invocation 01.

## Exact inputs (begin here; do not tour the repo)
- Commission: `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/commission.md` (the assignment, angle, and the required/
  starting source list — read it fully; it names every source obligation).
- Editorial direction: `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/editorial-direction.md` (house + series standards).

## Exact output (write only this)
- `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/researcher/01/evidence.md` — the evidence record, in the skill's
  stable sections (opening paragraph; Sources; Contradictions; Numbers; Source
  assets; Discarded).

## Source policy for this article (when-ai-breaks)
...
- nb executable: `/home/user/the-nightly-build/nb` (run commands with the main checkout as CWD:
  ...
  `/home/user/the-nightly-build/nb history --library /home/user/library-checkout --series when-ai-breaks --limit 20`.
...
Return exactly one line: `DONE researcher .nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/researcher/01/evidence.md`,
