# Editor review-brief 01 — when-ai-breaks/google-flu-trends
...
- The exact writer brief (for prompt-leakage detection):
  `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/writer/01/brief.md`.
...
- Evidence record: `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/researcher/01/evidence.md` (open as a map in the
...
- Draft handoff (open the original-work sentence only in the third read):
  `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/writer/01/draft-handoff.md`.
- The article to review and edit in place: `.nb-work/when-ai-breaks/google-flu-trends/library/when-ai-breaks/google-flu-trends.html`.
- Template context: `.nb-work/when-ai-breaks/google-flu-trends/.nb-context/`.
...
habits. Read it in `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/commission.md` and flag any that recur.

## Permitted edits (surgical, never a rewrite)
- Make cuts and small prose fixes (up to a word or clause) directly in `.nb-work/when-ai-breaks/google-flu-trends/library/when-ai-breaks/google-flu-trends.html`.
...
- `.nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/editor/01/editorial-review.md` with the three required lines
...
Return exactly one line: `DONE editor .nb-work/when-ai-breaks/google-flu-trends/agent-artifacts/when-ai-breaks/google-flu-trends/editor/01/editorial-review.md` only
