# Writer brief 01 — what-could-go-wrong/jailbreaks
...
- Commission: `.nb-work/what-could-go-wrong/jailbreaks/agent-artifacts/what-could-go-wrong/jailbreaks/commission.md` (this article's angle, reader, contribution,
...
- Evidence record: `.nb-work/what-could-go-wrong/jailbreaks/agent-artifacts/what-could-go-wrong/jailbreaks/researcher/01/evidence.md` — the COMPLETE set of claims
...
- Initialized article (edit this file, do not recreate its skeleton):
  `.nb-work/what-could-go-wrong/jailbreaks/library/what-could-go-wrong/jailbreaks.html`
- Template context: `.nb-work/what-could-go-wrong/jailbreaks/.nb-context/` (template-contract.yaml, runtime-assets.yaml,
  furniture/{engine,press,template}.md). Author against documented furniture only.

## Exact outputs (write only these)
- The article HTML at `.nb-work/what-could-go-wrong/jailbreaks/library/what-could-go-wrong/jailbreaks.html` (fill it in place).
- `.nb-work/what-could-go-wrong/jailbreaks/agent-artifacts/what-could-go-wrong/jailbreaks/writer/01/draft-handoff.md` (per the skill: original-work sentence;
  paths changed; proof result + any warnings left; evidence/voice questions).
- Any chart provenance / source asset only under `.nb-work/what-could-go-wrong/jailbreaks/library/what-could-go-wrong/jailbreaks/`
...
- Fill `nb-meta` with ACTUAL values: series=what-could-go-wrong, slug=jailbreaks, template=lesson,
...
```
cd /home/user/the-nightly-build && ./nb check .nb-work/what-could-go-wrong/jailbreaks/library/what-could-go-wrong/jailbreaks.html --series what-could-go-wrong --repo /home/user/the-nightly-build --library /home/user/library-checkout --no-check-links
```
Then run the FINAL proof once WITH link checking (URLs must resolve) and confirm
`BLOCK: 0`:
```
cd /home/user/the-nightly-build && ./nb check .nb-work/what-could-go-wrong/jailbreaks/library/what-could-go-wrong/jailbreaks.html --series what-could-go-wrong --repo /home/user/the-nightly-build --library /home/user/library-checkout
```
...
`DONE writer .nb-work/what-could-go-wrong/jailbreaks/agent-artifacts/what-could-go-wrong/jailbreaks/writer/01/draft-handoff.md`, or a REQUEST line above.
