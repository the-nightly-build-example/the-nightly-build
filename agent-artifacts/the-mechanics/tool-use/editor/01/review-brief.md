# Editor review-brief 01 — the-mechanics/tool-use
...
- The exact writer brief (for prompt-leakage detection):
  `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/writer/01/brief.md`.
- Voice guide: `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/writing-coach/01/voice-guide.md`.
- Evidence record: `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/researcher/01/evidence.md` (open as a map in the
...
- Draft handoff (open the original-work sentence only in the third read):
  `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/writer/01/draft-handoff.md`.
- The article to review and edit in place: `.nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use.html`.
- Template context: `.nb-work/the-mechanics/tool-use/.nb-context/`.
...
habits. Read it in `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/commission.md` and flag any that recur.

## Permitted edits (surgical, never a rewrite)
- Make cuts and small prose fixes (up to a word or clause) directly in `.nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use.html`.
...
- `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/editor/01/editorial-review.md` with the three required lines
...
Return exactly one line: `DONE editor .nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/editor/01/editorial-review.md` only
