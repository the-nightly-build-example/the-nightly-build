# Writer brief 01 — the-mechanics/tool-use
...
- Editorial direction: `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/editorial-direction.md` (house floor, headlines
  spec, press voice, lesson identity + furniture, series prompt — the standing law).
- Commission: `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/commission.md` (this article's angle, reader, contribution,
  source obligations, prior-coverage links, structures NOT to repeat, tags).
- Voice guide: `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/writing-coach/01/voice-guide.md`.
- Evidence record: `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/researcher/01/evidence.md` — the COMPLETE set of claims
...
- Initialized article (edit this file, do not recreate its skeleton):
  `.nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use.html`
- Template context: `.nb-work/the-mechanics/tool-use/.nb-context/` (template-contract.yaml, runtime-assets.yaml,
  furniture/{engine,press,template}.md). Author against documented furniture only.

## Exact outputs (write only these)
- The article HTML at `.nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use.html` (fill it in place).
- `.nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/writer/01/draft-handoff.md` (per the skill: original-work sentence;
  paths changed; proof result + any warnings left; evidence/voice questions).
- Any chart provenance / source asset only under `.nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use/`
...
- Fill `nb-meta` with ACTUAL values: series=the-mechanics, slug=tool-use, template=lesson,
...
```
cd /home/user/the-nightly-build && ./nb check .nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use.html --series the-mechanics --repo /home/user/the-nightly-build --library /home/user/library-checkout --no-check-links
```
Then run the FINAL proof once WITH link checking (URLs must resolve) and confirm
`BLOCK: 0`:
```
cd /home/user/the-nightly-build && ./nb check .nb-work/the-mechanics/tool-use/library/the-mechanics/tool-use.html --series the-mechanics --repo /home/user/the-nightly-build --library /home/user/library-checkout
```
...
`DONE writer .nb-work/the-mechanics/tool-use/agent-artifacts/the-mechanics/tool-use/writer/01/draft-handoff.md`, or a REQUEST line above.
