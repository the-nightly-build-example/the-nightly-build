...
| Default paper             | Three scaffolded series and a default voice; the paragraph that opens each prompt is the edit        | `nb setup`; see [Create your paper](../getting-started/create-your-paper.md)                                     |
